...
```
export UserPoolClientId=6u89sh6ee8oi0cha6ouerj1j3s
export UserPoolId=us-west-2_9ituyYeal
export IdentityPoolId=us-west-2:31e781cb-f306-4523-bf68-eed8eb2fd846
export apiUrl=https://79r1ceeuld.execute-api.us-west-2.amazonaws.com/dev
...
aws s3 ls s3://bad-notes-app-api-dev-attachmentsbucket-1wl3mwf7ne2du/private
```
